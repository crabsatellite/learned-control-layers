/**
 * NuWLS-DAC: NuWLS MaxSAT solver with Dynamic Algorithm Configuration support.
 *
 * Based on NuWLS (AAAI 2023) by Yi Chu et al.
 * Modified to support:
 ...
 *
 * Usage:
 *   Normal mode:  nuwls-dac <instance.wcnf> <seed>
 *   DAC mode:     nuwls-dac <instance.wcnf> <seed> --dac 10000
 *
 * DAC Protocol:
